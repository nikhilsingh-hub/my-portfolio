...
function ProjectCard({ project, index }) {
  ...
  return (
    <div ref={cardRef} className={`w-full md:w-[45%] border-2 border-black rounded-lg sticky overflow-hidden shadow-lg bg-gradient-to-br from-gray-900 to-black text-white`} style={{ top: `${index<2 ? 7 + index*4 : 11}rem` }}>
